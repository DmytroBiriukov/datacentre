...
$.fn.editInPlace.defaults = {
	...
	save_button:		'<button class="inplace_save">Зберегти</button>', // string: image button tag to use as “Save” button
	cancel_button:		'<button class="inplace_cancel">Відмінити</button>', // string: image button tag to use as “Cancel” button
	...
	default_text:		"(Клікніть для введення тексту)", // string: text to show up if the element that has this functionality is empty
	...
	select_text:		"Виберіть значення", // string: default text to show up in select box
