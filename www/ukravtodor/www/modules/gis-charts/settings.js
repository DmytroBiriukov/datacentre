...
/*      Event when line edit control selected (update line information)        */
	$("#update_place").load("modules/gis-charts/roads-data.php", { id : feature.fid.slice(10)} );
}
...
function loadSld(filename){
    base_layer.mergeNewParams({sld :'http://91.202.128.36/modules/gis-charts/SLD/' + filename + '.sld'});
    }
    
//Attention! Test functions
function loadSld_1_1(filename){
    base_layer.mergeNewParams({sld :'http://91.202.128.36/modules/gis-charts/SLD/ratings_1-1.sld'});
    }
function loadSld_1_2(filename){
    base_layer.mergeNewParams({sld :'http://91.202.128.36/modules/gis-charts/SLD/ratings_1-2.sld'});
    }
function loadSld_3(filename){
    base_layer.mergeNewParams({sld :'http://91.202.128.36/modules/gis-charts/SLD/ratings_3.sld'});
    }
function loadSld_4(filename){
    base_layer.mergeNewParams({sld :'http://91.202.128.36/modules/gis-charts/SLD/ratings_4.sld'});
    }
