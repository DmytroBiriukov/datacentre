<?  $module_path="modules/data-eform-manager/data-eform-manager.php";
?>
<?   include("../../../cgi-bin/db_functions.php"); 
?>
<img src="modules/data-eform-manager/data-eform-manager.png"/>
...
{ if(document.forms['form0'].elements['title'].value != "" && document.forms['form0'].elements['description'].value != "")
  { $('#moduleInfo').load('modules/data-eform-manager/create_ind_tab.php',{title:document.forms['form0'].elements['title'].value, description:document.forms['form0'].elements['description'].value});
...
{ if(document.forms['form2'].elements['title'].value != "")
  { $('#moduleInfo').load('modules/data-eform-manager/add_param.php',{tabtitle:document.forms['form2'].elements['tabtitle'].value, title:document.forms['form2'].elements['title'].value, ptype:document.forms['form2'].elements['ptype'].value});
...
function criterionTypeChanged(t, tag_id)
{ var tag_e=document.getElementById(tag_id);
  switch(t)
  { case 'char': tag_e.innerHTML= 
...
"<p>Напрямок оптимізації: &nbsp;<select name=\"opt\"><option id=\"opt\" value=\"max\" selected=\"selected\">більші значення є кращими</option><option id=\"opt\" value=\"min\">менші значення є кращими</option></select></p>"; 				 
                 break;
    default: tag_e.innerHTML= "";
  }
}
</script>

<div id="accordion">
	<h3><a href="#">Створення таблиць даних для зберігання значень показників електронних форм звітності</a></h3>
	<div>
...
<p><input name="submitbutton" type="submit" value="Створити таблицю"/></p>
	...
	<h3><a href="#">Внесення параметрів електронної форми звітності</a></h3>
	<div>
<form id="form2" name="form2" method="post" action="" onSubmit="return form2check()">
<p>Назва параметру: &nbsp;<input type="text" name="title" id="title" /></p>
<!--<p>Одиниці вимірювання: &nbsp;<input type="text" name="measure" id="measure" /></p>-->
<p>Електронна форма звітності: &nbsp;<select name="tabtitle" id="tabtitle">
...
?></select></p>
<!--<p>Назва атрибуту в таблиці даних (латинськими літерами): &nbsp;<input type="text" name="pfield" id="pfield" /></p>-->
...
<p><input name="submitbutton" type="submit" value="Додати параметр" /> </p>                                                
	...
	<h3><a href="#">Внесення інформації про показники електронної форми звітності</a></h3>
	<div>
...
<p>Тип показника: &nbsp;<select name="type" onchange="criterionTypeChanged(document.forms['form1'].elements['type'].value, 'characteristics1');">      
