<div id="bar-charts">
 	  <p>Стовпчикова діаграма:</p>
      <div id="diag-bars-1" style="width:450px;height:240px;"></div>
      <div id="diag-bars-choices">Показники:</div>
</div>
...
?>   	
 ...
 // insert checkboxes 
    var choiceContainer = $("#diag-bars-choices");
    $.each(datasets, function(key, val) {
