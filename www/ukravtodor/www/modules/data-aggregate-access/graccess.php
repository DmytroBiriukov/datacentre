...
//  
 ...
 $query2 = " INSERT INTO module2user (userprf, module, start_date, end_date, title) VALUES ( '".$id_user."', '30', '".$start_date."', '".$end_date."','". $title."'); "; 
 mysql_query($query2,$con);
 $id=mysql_insert_id($con);
 $query3 = " INSERT INTO module2user2param (ID_share, userprf, module, param, value) VALUES ('".$id."', '".$id_user."', '30', '13', '".$id_eform."'),";
 $query3 .= " ('".$id."', '".$id_user."', '30', '16', '".$start_date."'),";
 $query3 .= " ('".$id."', '".$id_user."', '30', '17', '".$end_date."'); "; 
/**/
 mysql_query($query3,$con); 
 /*
 $query1 = " INSERT INTO eform2user2param (ID_share, param, 	value) VALUES ";
 $i=0;
